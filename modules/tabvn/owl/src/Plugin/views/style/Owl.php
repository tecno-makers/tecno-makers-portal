...
class Owl extends StylePluginBase {
  ...
  protected function defineOptions() {
    ...
    $settings['pager_content'] = array('default' => '');
    return $options;
  }
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $form['pager_content'] = array(
      '#type' => 'textfield',
      '#title' => $this->t('Pager content selector'),
      '#default_value' => $this->options['pager_content'],
      '#description' => $this->t('This will clone the value from selector and insert to the pager item.'),
    );
    //paginationNumbers
